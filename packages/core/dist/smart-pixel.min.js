(function(){var c=new function(){function a(a){b.Y=function(b,d){return a.setTimeout(b,d)};b.W=function(b){a.clearTimeout(b)};b.wa=function(b,d){return a.setInterval(b,d)};b.Ha=function(b){a.clearInterval(b)};b.ia=a.screen;b.Fc=a.console;b.ba=a.navigator||{};b.bb=a.history||{};b.R=((a.navigator||{}).userAgent||"").toLowerCase()}var b=this;b.w="wtstp_";b.j="wtstp_";b.Ec="wtstp_";b.Dc="wt_";b.b=null;b.i=null;b.Y=null;b.W=null;b.wa=null;b.Ha=null;b.Fc=null;b.ba=null;b.R=null;b.ia=null;b.ja=null;b.bb=null;b.Ca=null;
b.ab=null;b.yb="onerror";b.Ab="onload";b.Vb="onreadystatechange";b.Ba=function(d,e){b.b=d;b.i=e;a(d);b.ja=e.location;b.Ca=e.body;b.ab=e.head}};var aa=Date.now,p={f:function(a){return"undefined"===typeof a},s:function(a){return null===a},Lb:function(a,b){return a instanceof b},U:function(a){return isNaN(a)},g:function(a){if(p.h(a))return""===a;if(p.B(a))return 0===a.length;if(p.u(a)&&p.T(a.hasOwnProperty)){var b=0;p.a(a,function(){b++});return 0===b}return!1},$a:function(a){return p.Lb(a,RegExp)},Qb:function(a,b){return p.$a(a)?a:b},h:function(a){return"string"===typeof a},C:function(a){return p.h(a)&&!p.g(a)},c:function(a,b){return p.h(a)?
...
La:function(a){return parseInt(p.Va(Math.random()*a))},X:function(){return aa()},kc:function(a){return a},gb:function(a,b){return a===b},oa:function(a,b){return a>b},Za:function(a,b){return a<b},ga:function(a,b){return a>=b},L:function(a,b){return a<=b},T:function(a){return"function"===typeof a},Eb:function(a,b){return p.T(a)?a:b},Ia:function(a){return"boolean"===typeof a},ka:function(a,b){return p.Ia(a)?a:b},S:function(a,b){var d=b;if(p.h(a))if("true"===a||"false"===a)d="true"===a;else{var e=parseInt(a);
...
function(a){return p.h(a)&&-1!==p.O(a,b)}),e.trackId=p.D(f)));if(!p.f(a.domain))if(p.h(a.domain)||p.$a(a.domain))e.domain=[ta(a.domain)];else if(p.B(a.domain)){var l=p.P(a.domain,function(a){return p.h(a)||p.$a(a)});p.g(l)||(p.a(l,function(a,b){l[a]=ta(b)}),e.domain=l)}}},G=new z(ua);var H={};function va(a,b){for(var d="",e=0;p.L(e,b);e++)d+="0";d+=a;return d.substring(d.length-b,d.length)}H.hc=function(a){var b=p.o(D("wt3_eid"),";");b=p.a(b,function(b,e){if(-1!==p.G(e,a+"|")){var d=p.H(e,new RegExp(a+"\\|"),"");return p.o(d,"#")[0]}});return p.c(b,"")};H.qb=function(){var a=Math.floor(p.X()/1E3);1089676800>a&&(a="3"+va(p.La(1E4),4)+va(p.La(1E5),5));return"2"+va(a,10)+va(p.La(1E8),8)};
...
widgetServiceUrl:""},g=null;return{name:"marketing_automation",version:"1.0.0",config:b,trigger:function(a){if(e&&"after"===a.type&&("page"===a.mode||"action"===a.mode)){var b="update";"page"===a.mode&&1===a.counter&&(b="body");g.push(b)}},isActivated:function(){return e},activate:function(){e||(e=!0,a.extension.teaser_tracking.activate(),p.s(g)&&(g=new od(a),g.i(b())))},deactivate:function(){e&&(e=!1)}}})};function qd(a){var b=this;b.b={};b.hb=500;b.i=3E3;b.j=function(d){var e=d.ca;if(p.f(b.b[e])){var f=d.ta;b.b[e]={rc:0===f?6E4:10<=f/60?f/60*1E3:1E4,ib:null,hb:b.hb,eb:{}}}(e="pos"!==d.fa)||(e=b.b[d.ca],f=p.X(),null===e.ib?(e.ib=f,e=!0):f-e.ib<e.rc?e=!1:(e.ib=f,e=!0));if(e){if(!(e="pos"===d.fa)){e=b.b[d.ca];f=d.fa+"_"+d.Sa;var g=p.X();p.f(e.eb[f])?(e.eb[f]=g,e=!0):p.L(g-e.eb[f],b.i)?(e.eb[f]=g,e=!1):(e.eb[f]=g,e=!0)}e&&(e=d.fa,p.L(b.b[d.ca].hb,0)&&"eof"!==e&&"stop"!==e||(b.b[d.ca].hb--,"eof"!==d.fa&&
"stop"!==d.fa||delete b.b[d.ca],a.cb.I.m(d),a.Ub()))}}};var rd=null;
...
a.action.parameter.add(f)}});e||(a.trackAction(!0),a.action.parameter.remove())}function h(a){var b="&ct=webtrekk_ignore";p.a(a,function(a,d){b+="&"+a+"="+yd.encode(p.D(d,";"))});return b}function l(a,b,d,e){p.u(b)?p.a(b,function(b,g){l(a+b,g,d,e)}):(p.f(e[a])&&(e[a]=[]),p.Za(e[a].length,d)&&m(a,d,e),e[a].push(b))}function m(a,b,d){for(var e=d[a].length;e<b;e++)d[a].push("")}function k(){if(p.L(B,0))return!1;if(-1!==n){if(p.L(E,0))return!0;E--;D(v,E+"")}return!1}var n=b.Cb,u=b.page,q=b.wc,r=p.o(a.init.get().trackId+
...
sa:0},width:{M:0,sa:0}},hidden:{height:{M:0,sa:0},width:{M:0,sa:0}}},d=a.getBoundingClientRect();b.Pa={height:p.Fa(d.height,a.clientHeight),width:p.Fa(d.width,a.clientWidth),top:d.top,right:d.right,bottom:d.bottom,left:d.left};a=b.Pa;d=0;(p.ga(a.top,0)||p.oa(a.top+a.height,0))&&p.Za(a.top,v)&&(d+=a.height,d+=p.Za(a.top,0)?a.top:0,d-=p.oa(a.top+a.height,v)?a.height+a.top-v:0);if(p.L(a.left+a.width,0)||p.ga(a.left,x))d=0;b.visible.height.sa=d;a=b.Pa;d=0;(p.ga(a.left,0)||p.oa(a.left+a.width,0))&&p.Za(a.left,
x)&&(d=a.width,d+=p.Za(a.left,0)?a.left:0,d-=p.oa(a.left+a.width,x)?a.left+a.width-x:0);if(p.L(a.top+a.height,0)||p.ga(a.top,v))d=0;b.visible.width.sa=d;b.visible.height.M=100*b.visible.height.sa/b.Pa.height;b.visible.width.M=100*b.visible.width.sa/b.Pa.width;b.hidden.height.sa=b.Pa.height-b.visible.height.sa;b.hidden.width.sa=b.Pa.width-b.visible.width.sa;b.hidden.height.M=100-b.visible.height.M;b.hidden.width.M=100-b.visible.width.M;return b}function m(){var a=c.i.documentElement;v=k.innerHeight||
...
function Sd(a){var b="";Rd()||(b+=a?"":Z.order.data.J());return b+=Z.page.data.J()}function Td(){var a=!Rd(),b=Z.utils;return!b.v.g(Sd())||!b.v.g(Od("view"))&&a||!b.v.g(Od("basket"))&&a||!b.v.g(Od("confirmation"))&&a}function Ud(){var a="page";if(Td())a="page";else if(!Z.utils.v.g(Z.Ya.I.J()))a="form";else if(!Z.utils.v.g(Z.cb.I.J()))a="media";else if(Rd()||!Td()&&!Z.utils.v.g(Qd(!0)))a="action";return a}
...
Z.product.basket.parameter.remove(),Z.product.confirmation.data.remove(),Z.product.confirmation.parameter.remove(),Z.session.data.remove(),Z.campaign.data.remove(),Z.customer.data.remove(),d&&!Z.rb)||(Rd()?Z.track():Z.utils.v.g(Z.cb.I.J())?!Z.utils.v.g(Z.Ya.I.J())&&Z.Tb():Z.Ub());Yd(g,"ready")}}};var $d={version:"6.3.7",debug:{enable:ca.dc,disable:ca.cc},action:Ya,advanced:A,campaign:eb,customer:ib,Ya:tb,init:G,cb:vb,order:zb,page:Db,product:Lb,session:Yb,jb:jc,utils:V,_ps:ja};ja(2048,"6.3.7");$d.utils.Ib=ca;
