...
describe('ContentEngagement via autotrack and data property', () => {
    ...
    test('add element with config - 1', done => {
        createWrapper(ContentEngagementDirectiveWithoutSelector, {
    ...
    test('add element with config - 2', done => {
        createWrapper(ContentEngagementDirectiveWithSelector, {
            trackId: '111111111111111',
            trackDomain: 'analytics01.wt-eu02.net',
            requestQueue: {
                activated: false
...
describe('ProductListTracking via autotrack and data property', () => {
    ...
    test('add element with config - 1', done => {
        createWrapper(ProductListDirectiveWithoutSelector, {
            trackId: '111111111111111',
            trackDomain: 'analytics01.wt-eu02.net',
            requestQueue: {
                activated: false
    ...
    test('add element with config - 2', done => {
        createWrapper(ProductListDirectiveWithSelector, {
            trackId: '111111111111111',
            trackDomain: 'analytics01.wt-eu02.net',
            requestQueue: {
                activated: false
...
describe('TeaserTracking via autotrack and data property', () => {
    ...
    test('add element with config - 1', done => {
        createWrapper(TeaserDirectiveWithoutSelector, {
            trackId: '111111111111111',
            trackDomain: 'analytics01.wt-eu02.net',
            requestQueue: {
                activated: false
    ...
    test('add element with config - 2', done => {
        createWrapper(TeaserDirectiveWithSelector, {
            trackId: '111111111111111',
            trackDomain: 'analytics01.wt-eu02.net',
            requestQueue: {
                activated: false
