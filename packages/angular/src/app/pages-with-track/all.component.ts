...
@Component({
    template: `<h1>{{ name }}</h1><div [wt-advanced-data]="advancedData" [wt-init-data]="initData" [wt-page-data]="pageData" [wt-session-data]="sessionData" [wt-campaign-data]="campaignData" [wt-customer-data]="customerData" [wt-order-data]="orderData" [wt-track]="1"></div>`
})
