(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('@webtrekk-smart-pixel/core')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', '@webtrekk-smart-pixel/core'], factory) :
  (global = global || self, factory(global['@webtrekk-smart-pixel/next'] = {}, global.React, global.PropTypes, global.wtSmart));
}(this, (function (exports, React, PropTypes, wtSmart) { 'use strict';
  ...
  var WebtrekkAutoTracking = /*#__PURE__*/function (_React$Component) {
    function WebtrekkAutoTracking() {
      ...
      return _callSuper(this, WebtrekkAutoTracking, arguments);
    }
