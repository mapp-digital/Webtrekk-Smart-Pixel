...
context('Vue3 Content Engagement', () => {
    beforeEach(() => {
        cy.smartIntercept();
    });

    it('content engagement scroll and view', () => {
        cy.visit('/apps/vue3/content-engagement');
        const trackData = [];
        ...
        cy.wait('@trackRequest').then(inception => {
            ...
            expect(pageview.p[1]).to.match(/.*apps\/vue3\/content-engagement$/);
            expect(pageview.pageName).to.match(/.*apps\/vue3\/content-engagement$/);
            expect(pageview.pu).to.match(/.*apps\/vue3\/content-engagement$/);
            ...
            expect(contentEngagement0.p[1]).to.match(/.*apps\/vue3\/content-engagement$/);
            expect(contentEngagement0.pageName).to.match(/.*apps\/vue3\/content-engagement$/);
            expect(contentEngagement0.pu).to.match(/.*apps\/vue3\/content-engagement$/);
            ...
            expect(contentEngagement25.p[1]).to.match(/.*apps\/vue3\/content-engagement$/);
            expect(contentEngagement25.pageName).to.match(/.*apps\/vue3\/content-engagement$/);
            expect(contentEngagement25.pu).to.match(/.*apps\/vue3\/content-engagement$/);
