...
context('Vue3 complete order process', () => {
    beforeEach(() => {
        cy.smartIntercept();
    ...
    it('login', () => {
        ...
        cy.contains('Your username is: Mapp').should('be.visible').then(() => {
            ...
            expect(pageRequest.p[1]).to.match(/.*apps\/vue3\/login$/);
            expect(pageRequest.pageName).to.match(/.*apps\/vue3\/login$/);
            expect(pageRequest.pu).to.match(/.*apps\/vue3\/login$/);
            ...
            expect(loginEvent.p[1]).to.match(/.*apps\/vue3\/login$/);
            expect(loginEvent.pageName).to.match(/.*apps\/vue3\/login$/);
            expect(loginEvent.pu).to.match(/.*apps\/vue3\/login$/);
            expect(loginEvent.ct).to.equal('Login');
            expect(loginEvent.cd).to.equal('Mapp');

            expect(followPage.eid).to.match(/^\d{19}$/);
            expect(followPage.p[1]).to.match(/.*apps\/vue3\/account$/);
            expect(followPage.pageName).to.match(/.*apps\/vue3\/account$/);
            expect(followPage.pu).to.match(/.*apps\/vue3\/account$/);
    ...
    it('account', () => {
        ...
        cy.contains('Your username is: Mapp').should('be.visible').then(() => {
            const pageRequest = trackData[0];
            expect(pageRequest.eid).to.match(/^\d{19}$/);
            expect(pageRequest.p[1]).to.match(/.*apps\/vue3\/account$/);
            expect(pageRequest.pageName).to.match(/.*apps\/vue3\/account$/);
            expect(pageRequest.pu).to.match(/.*apps\/vue3\/account$/);
            expect(pageRequest.fns).to.equal('1');
            expect(pageRequest.one).to.equal('1');
    ...
    it('shop list and add', () => {
        ...
        cy.wait('@trackRequest').then(inception => {
            ...
            expect(pageRequest.eid).to.match(/^\d{19}$/);
            expect(pageRequest.p[1]).to.match(/.*apps\/vue3\/shop$/);
            expect(pageRequest.pageName).to.match(/.*apps\/vue3\/shop$/);
            expect(pageRequest.pu).to.match(/.*apps\/vue3\/shop$/);
            expect(pageRequest.fns).to.equal('1');
            expect(pageRequest.one).to.equal('1');

            expect(productList.eid).to.match(/^\d{19}$/);
            expect(productList.p[1]).to.match(/.*apps\/vue3\/shop$/);
            expect(productList.pageName).to.match(/.*apps\/vue3\/shop$/);
            expect(productList.pu).to.match(/.*apps\/vue3\/shop$/);
            ...
            expect(product1add.p[1]).to.match(/.*apps\/vue3\/shop$/);
            expect(product1add.pageName).to.match(/.*apps\/vue3\/shop$/);
            expect(product1add.pu).to.match(/.*apps\/vue3\/shop$/);
            ...
            expect(product2add1.p[1]).to.match(/.*apps\/vue3\/shop$/);
            expect(product2add1.pageName).to.match(/.*apps\/vue3\/shop$/);
            expect(product2add1.pu).to.match(/.*apps\/vue3\/shop$/);
            ...
            expect(product2add2.p[1]).to.match(/.*apps\/vue3\/shop$/);
            expect(product2add2.pageName).to.match(/.*apps\/vue3\/shop$/);
            expect(product2add2.pu).to.match(/.*apps\/vue3\/shop$/);
    ...
    it('Single product multi add', () => {
        ...
        cy.wait('@trackRequest').then(inception => {
            ...
            expect(pageView.p[1]).to.match(/.*apps\/vue3\/shop\/6$/);
            expect(pageView.pageName).to.match(/.*apps\/vue3\/shop\/6$/);
            expect(pageView.pu).to.match(/.*apps\/vue3\/shop\/6$/);
            ...
            expect(productAdd.p[1]).to.match(/.*apps\/vue3\/shop\/6$/);
            expect(productAdd.pageName).to.match(/.*apps\/vue3\/shop\/6$/);
            expect(productAdd.pu).to.match(/.*apps\/vue3\/shop\/6$/);
    ...
    it('Add order', () => {
        ...
        cy.wait('@trackRequest').then(inception => {
            ...
            expect(pageView.eid).to.match(/^\d{19}$/);
            expect(pageView.p[1]).to.match(/.*apps\/vue3\/$/);
            expect(pageView.pageName).to.match(/.*apps\/vue3\/$/);
            expect(pageView.pu).to.match(/.*apps\/vue3\/$/);
            expect(pageView.cp1).to.equal('Homepage');
            expect(pageView.cp2).to.equal('Child');

            expect(openCartEvent.eid).to.match(/^\d{19}$/);
            expect(openCartEvent.p[1]).to.match(/.*apps\/vue3\/$/);
            expect(openCartEvent.pageName).to.match(/.*apps\/vue3\/$/);
            expect(openCartEvent.pu).to.match(/.*apps\/vue3\/$/);
            ...
            expect(orderRequest.pu).to.match(/.*apps\/vue3\/$/);
            ...
            expect(closeCartEvent.p[1]).to.match(/.*apps\/vue3\/$/);
            expect(closeCartEvent.pageName).to.match(/.*apps\/vue3\/$/);
            expect(closeCartEvent.pu).to.match(/.*apps\/vue3\/$/);
